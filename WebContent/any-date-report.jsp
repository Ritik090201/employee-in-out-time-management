...
<html>
 ...
 String ad=TimeAndDate.changeDateFormat(date);
 PreparedStatement ps=cn.prepareStatement("select * from empoutin where date=?");
 ps.setString(1,ad);
 ResultSet rst=ps.executeQuery();
 %>
 <div class='dvv'>
     <label class='lahu'>Report of date <%=ad%></label>
  </div>
  <div class='container'>
